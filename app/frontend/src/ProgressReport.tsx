      ...
      {selectedDog ? (
        <div className="mt-4">
          ...
          <a
            ...
            download
            className="mt-2 ml-4 inline-flex items-center gap-1 text-sm text-green-700 bg-green-50 hover:bg-green-100 px-3 py-1 rounded-lg font-medium transition-colors"
          >
            📥 Export CSV
          </a>
