...
**Do NOT run tests, builds, or linters** (`npm test`, `npm run build`, `npm run lint`, etc.). CI runs them on the PR. This is a static review of the diff only. Don't ask for test output in the PR body either.
